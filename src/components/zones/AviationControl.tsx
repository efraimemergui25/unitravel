...
// AI curated pick for TLV→MEX routing logic
const AI_PICKS = new Set([
  'google-flights', 'kayak', 'skyscanner', 'kiwi',
  ...
  return (
    <motion.button
      ...
      animate={{
        ...
        // Glowing inset-white shadow when active — the "on" state signature
        boxShadow: isActive
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        >
          ...
          <AnimatePresence mode="wait">
            {mode === 'ai' ? (
              ...
              >
                ✦ Optimized for TLV→MEX. AI selected 10 highest-yield engines.
              </motion.p>
            ) : (
              <motion.p
                key="god"
              ...
              >
                Full manual control. Toggle any of the 30 global aviation engines.
              </motion.p>
            )}
          </AnimatePresence>
        </div>
        ...
        <div
          style={{ flex: 1, overflowY: 'auto', padding: '10px 11px 6px', minHeight: 0 }}
        >
